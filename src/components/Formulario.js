...
const Formulario = ({
  ...
  const [paciente, guardarPaciente] = useState(""); //para reserva nombre
  const [telefono, guardarTelefono] = useState("");//cantidad
  const [fecha, guardarFecha] = useState("");
  const [hora, guardarHora] = useState("");
  const [fumadores, setFumadores] = useState("");//area de reserva
  ...
  const crearNuevaCita = () => {
    ...
    const cita = { paciente, telefono, fecha, hora, fumadores };
    ...
    <>
      <ScrollView style={styles.formulario}>
        ...
        <RNPickerSelect
          ...
          onValueChange={(value) => setFumadores(value)}
          placeholder={{ label: "Selecciona area de mesa : ", value: "" }}
          items={[
